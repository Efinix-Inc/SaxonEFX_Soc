...
class EfxOpalSoc_t8System() extends Generator{
...
class EfxOpalSoc_t8SystemWithArgs(p : EfxRiscvBmbDdrSocParameter) extends EfxOpalSoc_t8System{
...
class EfxOpalSoc_t8(p : EfxRiscvBmbDdrSocParameter) extends Generator{
  ...
  val system = new EfxOpalSoc_t8SystemWithArgs(p)
...
object EfxOpalSoc_t8 {
  ...
  def main(args: Array[String]): Unit = {
    val report = SpinalRtlConfig.copy(
      ...
      if(p.softTap == true) {
        val toplevel = new EfxOpalSoc_t8(p){
        system.cpu.enableJtag(debugCd, systemCd)

        }.toComponent("OpalSoc_t8_softTap")
    ...
    BspGenerator("efinix/EfxOpalSoc_t8", report.toplevel.generator, report.toplevel.generator.system.cpu.dBus)
  }
}
