...
#define DMASG_BASE IO_DMA_CTRL_INPUT
...
#define CARRIER_HDMI_OUT_CONFIG_LEN  (41)
uint8_t carrier_hdmi_out_config[CARRIER_HDMI_OUT_CONFIG_LEN][3] =
{
    {ADV7511_ADDR>>1, 0xD6, 0xC0}, // for disable HPD
...
//	{ADV7511_ADDR>>1, 0x18, 0x00},
//	{ADV7511_ADDR>>1, 0x19, 0x00},
//	{ADV7511_ADDR>>1, 0x1A, 0x00},
//	{ADV7511_ADDR>>1, 0x1B, 0x00},
//	{ADV7511_ADDR>>1, 0x1C, 0x0F},
//	{ADV7511_ADDR>>1, 0x1D, 0x00},
//	{ADV7511_ADDR>>1, 0x1E, 0x00},
//	{ADV7511_ADDR>>1, 0x1F, 0x00},
//
//	{ADV7511_ADDR>>1, 0x20, 0x00},
//	{ADV7511_ADDR>>1, 0x21, 0x00},
//	{ADV7511_ADDR>>1, 0x22, 0x00},
//	{ADV7511_ADDR>>1, 0x23, 0x00},
//	{ADV7511_ADDR>>1, 0x24, 0x00},
//	{ADV7511_ADDR>>1, 0x25, 0x00},
//	{ADV7511_ADDR>>1, 0x26, 0x00},
//	{ADV7511_ADDR>>1, 0x27, 0x00},
//
//	{ADV7511_ADDR>>1, 0x28, 0x00},
//	{ADV7511_ADDR>>1, 0x29, 0x00},
//	{ADV7511_ADDR>>1, 0x2A, 0x00},
//	{ADV7511_ADDR>>1, 0x2B, 0x00},
//	{ADV7511_ADDR>>1, 0x2C, 0x00},
//	{ADV7511_ADDR>>1, 0x2D, 0x00},
//	{ADV7511_ADDR>>1, 0x2E, 0x00},
//	{ADV7511_ADDR>>1, 0x2F, 0x00},
...
void vgaI2c(){
    ...
    //Write Values to ADV7511:
    for( i = 0; i < CARRIER_HDMI_OUT_CONFIG_LEN; i++)
    {
        i2c_masterStartBlocking(I2C_CTRL);
        //uart_writeStr(BSP_UART_TERMINAL, "i2c_masterStartBlocking\n\r");

        i2c_txByte(I2C_CTRL, 0x72 /*carrier_hdmi_out_config[i][0]*/); i2c_txNackBlocking(I2C_CTRL);
        //uart_writeStr(BSP_UART_TERMINAL, "i2c_txByte = Device Address\n\r");

        i2c_txByte(I2C_CTRL, carrier_hdmi_out_config[i][1]); i2c_txNackBlocking(I2C_CTRL);
        //uart_writeStr(BSP_UART_TERMINAL, "i2c_txByte = Register Address\n\r");

        i2c_txByte(I2C_CTRL, carrier_hdmi_out_config[i][2]); i2c_txNackBlocking(I2C_CTRL);
        //uart_writeStr(BSP_UART_TERMINAL, "i2c_txByte = IIC Data\n\r");

        i2c_masterStopBlocking(I2C_CTRL);

/*
        uart_writeStr(BSP_UART_TERMINAL, "Slave Address = "); print_hex_byte(0x72);
        uart_writeStr(BSP_UART_TERMINAL, ", ");
        uart_writeStr(BSP_UART_TERMINAL, "Register Address = "); print_hex_byte(carrier_hdmi_out_config[i][1]);
        uart_writeStr(BSP_UART_TERMINAL, ", ");
        uart_writeStr(BSP_UART_TERMINAL, "IIC TX Data = "); print_hex_byte(carrier_hdmi_out_config[i][2]);
        uart_writeStr(BSP_UART_TERMINAL, ",\n\r");*/
    }
    //Read a register from ADV7511
/*
    i2c_masterStartBlocking(I2C_CTRL);
    i2c_txByte(I2C_CTRL, 0x72); i2c_txNackBlocking(I2C_CTRL);
    i2c_txByte(I2C_CTRL, 0x16); i2c_txNackBlocking(I2C_CTRL);

    i2c_masterStartBlocking(I2C_CTRL);
    i2c_txByte(I2C_CTRL, 0x73); i2c_txNackBlocking(I2C_CTRL);
    i2c_txByte(I2C_CTRL, 0xff); i2c_txNackBlocking(I2C_CTRL);
    iic_data = i2c_rxData(I2C_CTRL);
    i2c_masterStopBlocking(I2C_CTRL);
    print_hex_byte(iic_data);*/
}